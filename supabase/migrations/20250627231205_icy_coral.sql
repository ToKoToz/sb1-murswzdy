/*
  # Safe Database Reset - No Privileged Storage Operations

  Cette migration effectue une réinitialisation complète de la base de données
  en évitant les opérations qui nécessitent des privilèges de propriétaire.
  
  Sections incluses :
  1. Nettoyage des tables de données (non système)
  2. Recréation du schéma simplifié
  3. Politiques RLS non-récursives
  4. Données de démonstration
  5. Buckets de stockage (sans gestion des politiques)
*/
...
-- Create storage buckets if they don't exist (safe operation)
...
-- NOTE: Storage policies will need to be created manually in the Supabase Dashboard
-- Go to Storage > Settings > Policies to create these policies:
-- 
