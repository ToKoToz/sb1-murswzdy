/*
  ...
  This migration completely resets the database to fix all loading issues:
  1. Drops ALL existing tables and functions that cause conflicts
  2. Creates a simple, working structure without RLS recursion
  3. Uses the original `profiles` table for compatibility
  4. Creates working demo accounts
  5. Implements non-recursive RLS policies
